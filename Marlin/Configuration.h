...
#define STRING_CONFIG_H_AUTHOR "(jrhuerta, Marlin-Stable-Prusa-Steel)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160, 160, 800, 198}  // default steps per unit for Ultimaker
