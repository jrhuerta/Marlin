...
#define STRING_CONFIG_H_AUTHOR "(jrhuerta, Hypercube)" // Who made the changes.
...
#define DUMMY_THERMISTOR_998_VALUE 70 
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Hypercube
  #define  DEFAULT_bedKp 170.67
  #define  DEFAULT_bedKi 12.40
  #define  DEFAULT_bedKd 587.22
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.25   // Z offset: -below +above  [the nozzle]
